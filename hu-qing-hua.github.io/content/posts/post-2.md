---
title: "Notes on \"The Missing Semester of CS\""
date: 2025-04-17T02:01:58+05:30
description: "开发中还是有很多工具之类的需要学习，比如我一直希望自己能丝滑用vim和轻松写脚本。感觉这个课程对我来说非常有用"
tags: [Note]
---
### 第一章
1.  terminal是负责处理输入输出的窗口，也负责处理窗口显示的字体颜色等。
>想起来我用的shell“皮肤”，starship。(starship,terminal)类似于(网页的js,浏览器引擎)（starship使用标准的ECMA-48控制序列（所有现代终端都支持），就像所有网页都可以在一个浏览器上跑一样
